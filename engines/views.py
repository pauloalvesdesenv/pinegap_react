...
def list_engines_view(request):
    ...
    autorefresh_task = PeriodicTask.objects.filter(name='[PO] Auto-refresh status')
...
def add_engine_view(request):
    ...
    if request.method == 'GET':
        ...
        if form.is_valid():
            ...
            engine.save()
            messages.success(request, 'Sensor criado com sucesso')
...
def delete_engine_view(request, engine_id):
    ...
    if request.method == 'POST':
        engine.delete()
        messages.success(request, 'Sensor excluido com sucesso!')
        return redirect('list_engines_view')
...
def edit_engine_view(request, engine_id):
    ...
    if request.method == 'GET':
        ...
        if form.is_valid():
            ...
            engine.save()
            messages.success(request, 'Sensor atualizado com sucesso')
            return redirect('list_engines_view')
...
def edit_policy_view(request, policy_id):
    ...
    if request.method == 'GET':
        ...
        if form.is_valid():
            ...
            policy.save()
            messages.success(request, 'Política atualizada com sucesso')
            return redirect('list_policies_view')
...
def add_engine_types_view(request):
    ...
    if request.method == 'GET':
        ...
        if form.is_valid():
            ...
            engine.save()
            messages.success(request, 'Novo tipo de sensor criado com sucesso')
...
def edit_engine_type_view(request, engine_id):
    ...
    if request.method == 'GET':
        ...
        if form.is_valid():
            ...
            engine.save()
            messages.success(request, 'Tipo de sensor atualizado com sucesso')
            return redirect('list_engine_types_view')
...
def delete_engine_type_view(request, engine_id):
    ...
    if request.method == 'POST':
        engine.delete()
        messages.success(request, 'Tipo de sensor excluido com sucesso!')
        return redirect('list_engine_types_view')
