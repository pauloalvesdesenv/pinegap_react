...
#Normalize DB Records Inconsistents  SQL - (Set Financeiro to Zero Value )
sql ='''UPDATE public.assets SET financeiro = NULL;'''
cursor.execute(sql)

#Commit SQL post Changes
conn.commit()
print("Table Field 'Financeiro' Modified to 'ZERO' Value successfully!!!")
